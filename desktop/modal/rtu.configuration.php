...
<div class="form-group">
    <label class="col-sm-4 control-label">{{Vitesse}}</label>
    <div class="col-sm-6">
...
<div class="form-group">
    <label class="col-sm-4 control-label">{{Taille de l'octet}}</label>
    <div class="col-sm-6">
...
<div class="form-group">
    <label class="col-sm-4 control-label">{{Bit de fin}}</label>
    <div class="col-sm-6">
